...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [QWERTY] = LAYOUT_split_3x5_3(
      ...
      XXXXXXX, OSL(NAV), KC_SPC, KC_BSPC, OSL(SYM), XXXXXXX
    ),
    ...
    [SOUL] = LAYOUT_split_3x5_3(
      ...
      KC_J, OSL(NAV), KC_SPC, KC_BSPC, OSL(SYM), XXXXXXX
    ),
    ...
    [UN] = LAYOUT_split_3x5_3(
      ...
      KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN,
      KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH,
      OSL(UN_EXTRA), OSL(NAV), KC_SPC, KC_BSPC, OSL(SYM), XXXXXXX
    ),
    ...
    [SYM] = LAYOUT_split_3x5_3(
      KC_TILD, KC_AT, KC_CIRC, KC_DLR, KC_PERC,       KC_SCLN, KC_RBRC, KC_LBRC, KC_HASH, KC_GRV,
      KC_PLUS, KC_MINUS, KC_EQL, KC_ASTR, KC_COLN,    KC_BSLS, KC_LCBR, KC_RCBR, KC_RPRN, KC_LPRN, 
      KC_LT, KC_EXLM, KC_PIPE, KC_GT, KC_AMPR,        KC_QUES, KC_DOT,  KC_SLSH, KC_DQUO, KC_QUOT,
